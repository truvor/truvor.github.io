...
class AppRoutingModule {
    ...
    static ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule.forRoot(routes, { relativeLinkResolution: 'legacy' })], _angular_router__WEBPACK_IMPORTED_MODULE_2__.RouterModule] });
}
...
class AppComponent {
    ...
    static ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 10, vars: 1, consts: [["src", "./assets/R4R-trinity_recoded.png", "alt", "album artwork", 1, "cover"], [3, "name", "url", 4, "ngFor", "ngForOf"], [3, "name", "url"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
class ItemComponent {
    name = '';
    url = '';
    static ɵfac = function ItemComponent_Factory(t) { return new (t || ItemComponent)(); };
    static ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ItemComponent, selectors: [["app-item"]], inputs: { name: "name", url: "url" }, decls: 2, vars: 2, consts: [[1, "item", 3, "href"]], template: function ItemComponent_Template(rf, ctx) { if (rf & 1) {
...
class LinkListComponent {
    ...
    static ɵfac = function LinkListComponent_Factory(t) { return new (t || LinkListComponent)(); };
    static ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LinkListComponent, selectors: [["app-link-list"]], decls: 2, vars: 0, template: function LinkListComponent_Template(rf, ctx) { if (rf & 1) {
